...
<Section class="flex flex-col gap-0 h-full">
  <TableHeader class="mb-3" title="Helpers" subtitle="Manage helpers">
    <div slot="below-head">
      <Button
        onClick={() => {
          createModal.show();
...
<Modal bind:this={createModal}>
  <ModalHeader>
    <Title class="text-lg md:text-lg">Add helper</Title>
    <Paragraph>Add a new helper to the system</Paragraph>
  </ModalHeader>
...
<Modal bind:this={editModal}>
  <ModalHeader>
    <Title class="text-lg md:text-lg">Edit helper</Title>
    <Paragraph>Edit a helper from the system</Paragraph>
  </ModalHeader>
